...
const services = [
    {
        "icon": "pe-7s-arc",
        "title": (<div>Financing up to <br/> AED 300,000</div>),
        "details": ""
    },
    {
        "icon": "pe-7s-paint-bucket",
        "title": "Competitive Fees starting from 1.2% per month",
        "details": ""
    },
    {
        "icon": "pe-7s-vector",
        "title": "Offers and Approvals within 48 hours",
        "details": ""
    }
]
...
const Services = () => {
    return (
        <section className="blck-nft services section-padding pt-60">
                            ...
                            <div className="col-lg-4" key={idx}>
                                <div className="item flex">
                                    ...
                                    <div className="cont-flex">
                                        <h6 className="mb-10 fw-700 pt-10">{service.title}</h6>
